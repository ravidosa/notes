...
# Nonlinear Dynamics and Chaos (Strogatz, 2e) Exercise 3.2.1
...
for ind, r_ in enumerate(R):
    plot_1d_vfield(lambda x_: r_ * x_ + x_ ** 2, (-2 - r_ / 2, 2 - r_ / 2), ax[ind // 3, ind % 3])
...
# |r| > 0 -> 1 unstable fp at x* = 0, 1 stable fp at x* = -r
