...
import { loadExternalFile, getFileDir } from './utils.js'
        ...
        for (let line of contents.split('\n')){
            ...
            switch(token) {
                ...
                case 'map_Kd':
                    ...
                    materials[current_material].map_kD = new ImageTexture(`${filepath}/${file_map_kd}`, gl)
                    break
                case 'map_Ns':
                    let file_map_ks = line.split(' ')[1]
                    materials[current_material].map_nS = new ImageTexture(`${filepath}/${file_map_ks}`, gl)
                    break
                case 'map_Bump':
                case 'bump':
                case 'norm':
                    ...
                    materials[current_material].map_norm = new ImageTexture(`${filepath}/${file_map_norm}`, gl)
                    break
            }
        }
