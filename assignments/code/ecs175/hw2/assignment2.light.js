...
class AmbientLight extends Light {
    ...
    update( ) {
        ...
        this.target_shader.setUniform3f(`u_lights_ambient[${this.id}].color`, new Float32Array(this.color))
...
class DirectionalLight extends Light {
    ...
    update( ) {
        ...
        vec3.transformMat4(dir, dir, this.model_matrix)
        ...
        this.target_shader.setUniform3f(`u_lights_directional[${this.id}].direction`, dir)
        this.target_shader.unuse()
    }
}
...
class PointLight extends Light {
    ...
    update( ) {
        ...
        let pos = vec3.fromValues(this.model_matrix[12], this.model_matrix[13], this.model_matrix[14])
        ...
        this.target_shader.setUniform3f(`u_lights_point[${this.id}].position`, pos)
        this.target_shader.unuse()
    }
}
