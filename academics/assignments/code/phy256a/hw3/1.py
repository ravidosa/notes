...
# Nonlinear Dynamics and Chaos (Strogatz, 2e) Exercise 9.3.2
...
parameters = (10.0, 10, 8/3) # sigma, R, b
...
# not very chaotic, trajectories spiral towards 2 stable fixed points