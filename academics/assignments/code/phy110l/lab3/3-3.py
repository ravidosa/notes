...
import os
from utils import Charge, launch, equipotential
...
eq_par_arr = [(0, -20)]
for x, y in eq_par_arr:
    equipotential((x, y), h, charge_list, ax, "green")
...
plt.savefig(os.path.join(os.path.dirname(__file__), "3-3.png"))
plt.show()