...
class App
{
    ...
    constructor( )
    {
        ...
        this.shaders = [
            ...
            new Shader( this.gl, '../../assignment2.goraud.vert.glsl', '../../assignment2.goraud.frag.glsl' ),
            new Shader( this.gl, '../../assignment2.phong.vert.glsl', '../../assignment2.phong.frag.glsl' ),
